...
const routes = [
  ...
  },
  {
    path: '/registercode',
    name: 'RegisterCode',
    component: () => import('../../../pages/RegisterCode.vue'),
    meta: {
      requiresAuth: false,
  ...
  },
  {
    path: '/approvechanges',
    name: 'ApproveChanges',
    component: () => import('../../../pages/ApproveChanges.vue'),
    meta: { requiresAuth: true, requiresGroup: ['Admins', 'Moderators'] },
  },
  {
    path: '/managecards',
    name: 'ManageCards',
    component: () => import('../../../pages/ManageCards.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/manageartifacts',
    name: 'ManageArtifacts',
    component: () => import('../../../pages/ManageArtifacts.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/manageequipment',
    name: 'ManageEquipment',
    component: () => import('../../../pages/ManageEquipments.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/artifact',
    ...
    meta: {
      requiresAuth: false,
      title: 'Artifact | Magic: Legends ARPG',
      metaTags: [
        {
          name: 'og:title',
          content: 'Artifact | Magic: Legends ARPG',
        },
        {
          name: 'og:image',
          content: '/logo.png',
  ...
  },
  {
    path: '/deckbuilder',
    name: 'DeckBuilder',
    component: () => import('../../../pages/DeckBuilder.vue'),
    meta: {
      requiresAuth: false,
  ...
  },
  {
    ...
    component: () => import('../../../pages/CollectionChecklist.vue'),
    meta: {
      requiresAuth: false,
      title:
  ...
  },
  {
    ...
    component: () => import('../../../pages/ContentCreators.vue'),
    meta: {
      requiresAuth: false,
      title:
  ...
  },
  {
    path: '/dpstracker',
    name: 'DpsTracker',
    component: () => import('../../../pages/DpsTracker.vue'),
    meta: {
      requiresAuth: false,
  ...
  },
  {
    path: '/geomancerlore',
    name: 'GeomancerLore',
    component: () => import('../../../pages/GeomancerLore.vue'),
    meta: {
      requiresAuth: false,
  ...
  },
  {
    path: '/loadoutbuilder',
    name: 'LoadoutBuilder',
    component: () => import('../../../pages/LoadoutBuilder.vue'),
    meta: {
      requiresAuth: true,
      title:
        'Loadout builder - Join us and share your build and guide | Magic: Legends ARPG',
      metaTags: [
        {
          name: 'og:title',
          content:
  ...
  },
  {
    path: '/loadout',
    name: 'Loadout',
    component: () => import('../../../pages/Loadout.vue'),
    meta: {
      requiresAuth: false,
      title:
        'Loadout - Join us and share your build and guide | Magic: Legends ARPG',
      metaTags: [
        {
          name: 'og:title',
          content:
  ...
  },
  {
    path: '/loadouts',
    name: 'Loadouts',
    component: () => import('../../../pages/Loadouts.vue'),
    meta: {
      requiresAuth: false,
      title:
        'Loadout - Join us and share your build and guide | Magic: Legends ARPG',
